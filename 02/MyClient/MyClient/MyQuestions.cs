...
namespace MyClient
{
    public partial class MyQuestions : DevExpress.XtraEditors.XtraUserControl
    {

        private PanelControl panel1;
        public MyQuestions(PanelControl panel2)
        {
            panel1 = panel2;
            InitializeComponent();
        }
        ...
        private void Delete_BTN_Click(object sender, EventArgs e)
        {
            ...
            Dictionary<string, string> param = GetClass.Main_Get_Request(paramssent, "/DeleteQuestion");
            // Dictionary<string, string> param = GetClass.Delete_Question(btn.Name);

            
            panel1.Controls.RemoveAt(0);
            MyQuestions myQuestionsform = new MyQuestions(panel1);
            panel1.Controls.Add(myQuestionsform); 
